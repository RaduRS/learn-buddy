...
export default function PuzzleGame({
  ...
  const backgroundSize = (gridSize: number) =>
  ...
  const handleDragStart = (ev: DragEvent<HTMLElement>, pieceId: string) => {
    ev.dataTransfer.setData("text/plain", pieceId);
    setSelectedPieceId(pieceId);
  };

  const handleDrop = (ev: DragEvent<HTMLElement>, targetId: string) => {
    ev.preventDefault();
